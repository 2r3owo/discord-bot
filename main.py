...
# ============================================================
# 디스코드 그림판 봇 - ALL IN ONE
#
# 설치:
#   pip install -U discord.py flask pillow
#
# 환경변수:
#   DISCORD_TOKEN = 디스코드 봇 토큰
#   DRAW_URL      = 그림판이 인터넷에서 접근 가능한 주소
#                   예: https://draw.example.com
#
# 실행:
#   python bot.py
#
# 주의:
#   DRAW_URL은 Discord 사용자들이 실제로 접속할 수 있는 주소여야 합니다.
#   localhost는 본인 컴퓨터에서만 접속됩니다.
# ============================================================

TOKEN = os.getenv("DISCORD_TOKEN", "여기에_봇_토큰")
DRAW_URL = os.getenv("DRAW_URL", "http://localhost:5000").rstrip("/")
PORT = int(os.getenv("PORT", "5000"))

if TOKEN == "여기에_봇_토큰":
    print("⚠️ DISCORD_TOKEN 환경변수를 설정하세요.")
...
@tree.command(name="그림", description="Discord 그림판을 엽니다.")
