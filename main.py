...
YDL_OPTIONS = {
    ...
    # 일반 유튜브 재생용 설정입니다. 차트 기능이 재생 설정을 건드리지 않도록 분리합니다.
    'extractor_args': {
        'youtube': {
...
if YT_COOKIE_FILE and os.getenv('YOUTUBE_USE_COOKIES', '0').strip() == '1':
...
# 기본값은 쿠키를 사용하지 않습니다. 필요할 때만 Railway 변수 YOUTUBE_USE_COOKIES=1로 켜세요.
