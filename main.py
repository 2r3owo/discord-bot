...
def _download_music_sync(query: str, guild_id: int):
    ...
    modes = [
        {"name": "web_safari", "extractor_args": {"youtube": {"player_client": ["web_safari"]}}},
        {"name": "android_vr", "extractor_args": {"youtube": {"player_client": ["android_vr"]}}},
        {"name": "web_embedded", "extractor_args": {"youtube": {"player_client": ["web_embedded"]}}},
        {"name": "mweb", "extractor_args": {"youtube": {"player_client": ["mweb"]}}},
    ]
    last_error = None
    for mode in modes:
        try:
