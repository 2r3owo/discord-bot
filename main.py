...
YDL_OPTIONS = {
    'format': 'bestaudio[ext=m4a]/bestaudio/best/worst',
    'noplaylist': True,
    'quiet': True,
    'no_warnings': False,
    'default_search': 'auto',
...
def make_youtube_options(mode, outtmpl):
    ...
    opts["format"] = "bestaudio[ext=m4a]/bestaudio/best/worst"
    ...
    if mode == "default":
        # YouTube가 제공하는 기본 포맷 목록에서 실제 사용 가능한 오디오를 선택합니다.
        # 특정 player client를 강제하면 Requested format is not available가 발생할 수 있습니다.
